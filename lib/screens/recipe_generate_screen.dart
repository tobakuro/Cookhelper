...
7.各ステップで、調味料などを入れる際は必ず分量を記載してください
8.タイマーが必要なステップ（煮込む、焼く、蒸す、冷やす等）には、ステップの最後に「[タイマー: XX秒]」または「[タイマー: XX分]」を必ず追加してください
以下の形式で提案してください：
...
タイマーが必要なステップには、説明の最後に「[タイマー: XX秒]」または「[タイマー: XX分]」を追記してください。

例：
ステップ1: 玉ねぎを薄切りにします
ステップ2: フライパンに油を大さじ1杯引いて中火で熱します
ステップ3: 玉ねぎを入れて透明になるまで炒めます [タイマー: 3分]
ステップ4: 弱火にして蓋をして煮込みます [タイマー: 10分]
